...
class RegistroAsistenciaPruebaCovidSitio{
    ...
    public function codigo($id) {
        ...
        <title>
            Asistencia Prueba Covid En Sitio CONAVE Convención 2022 ASOFARMA
        </title>
        <!--     Fonts and icons     -->
...
html;
        ...
        if($flag == true)
        {
            ...
            View::render("registro_asistencias_prueba_covid_sitio");
        }
        else
        {
